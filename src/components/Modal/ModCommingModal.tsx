...
interface ICharaccterCommingModalProps {
  isCommingMod: boolean
  setIsCommingMod: React.Dispatch<React.SetStateAction<boolean>>
}
...
export default function ModCommingModal({
  isCommingMod,
  setIsCommingMod,
}: ICharaccterCommingModalProps) {
  const handleClose = () => {
    setIsCommingMod(false)
  }
